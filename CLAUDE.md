...
- **`docs/architecture.html`** — the *architecture*, in three parts: the hardware, the app, and the protocol where they meet, plus a state section listing what runs today and what is next. Only current, decided material — no history, no narrative.
